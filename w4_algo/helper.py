...
def main():
    ...
    user2_private_key = get_private_key_from_mnemonic(user2_mnemonic)

    # declare application state storage (immutable)
    local_ints = 0
    local_bytes = 1
    global_ints = (
        25  # 4 for setup + 20 for choices. Use a larger number for more choices.
    )
    global_bytes = 1
    ...
    asa_id = create_algorand_standard_asset(
        algod_client,
        user2_private_key,
        "enb",
        "ENB",
        ...
        user_address,
        user_address,
        "https://path/to/my/asset/details",
        False
    )
    print("My ASA ID:", asa_id)
