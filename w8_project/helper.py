...
from counter import approval_program, clear_state_program
...
def main():
    ...
    call_app(algod_client, user_private_key, app_id, [b"inc"])
    ...
    print("Global state:", global_state)
    call_app(algod_client, user_private_key, app_id, [b"dec"])
